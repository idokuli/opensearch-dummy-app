...
{{/*
Name of the Secret holding OpenSearch basic-auth credentials — the
pre-existing one if set, otherwise the one this chart creates.
*/}}
{{- define "data-prepper.opensearchSecretName" -}}
{{- .Values.existingSecret | default (printf "%s-opensearch-auth" (include "data-prepper.fullname" .)) }}
{{- end }}
